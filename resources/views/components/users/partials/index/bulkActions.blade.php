<div class="flex items-center gap-4"
	...
	<select class="border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm block w-full mb-0"
			x-model="action"
	...
	<button class="button button-primary shadow-sm"
